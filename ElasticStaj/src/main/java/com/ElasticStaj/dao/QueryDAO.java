package com.ElasticStaj.dao;


import com.google.gson.Gson;
import com.ElasticStaj.entity.Document;
import com.ElasticStaj.prop.ConfigProps;
...
public class QueryDAO {
    ...
    @Autowired
    public QueryDAO(SearchSourceBuilder sourceBuilder,
    ...
    public String createIndex(Document document){
        ...
        try {
            ...
            request = new IndexRequest(props.getIndex().getName(), props.getIndex().getType());
